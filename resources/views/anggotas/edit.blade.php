...
<form action="{{ route('anggotas.update',$anggota->id) }}" method="POST">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input min="0" class="form-control" type="number" name="IUD" required value="{{$anggota->IUD}}"
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama" value="{{$anggota->nama}}" placeholder="Nama Anggota">
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input min="0" type="number" class="form-control" name="no_hp" value="{{ $anggota->no_hp }}"
